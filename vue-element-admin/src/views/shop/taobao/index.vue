  ...
  <div class="container">
    <div style="height: 250px; width: 100%;">
      ...
      <el-card class="box-card card-container">
        ...
        <div class="form-row">
          <span class="form-label">模板名称：</span> 淘宝商品评论爬取
        </div>
        <div class="form-row">
          <span class="form-label">采集字段：</span> 商品id，评论id，用户昵称，颜色分类，评论内容，评论时间，页码
        </div><div class="form-row">
          <span class="form-label">关键词示例：</span> 598688549184 (商品id)
        </div>
...
<script>
import img from './img/taobao.png'
...
export default {
  ...
  methods: {
    crawl() {
      ...
      axios.get(`http://localhost:8080/taobao?key=${this.keyword}&page=${this.pagenum}`).then(res => {
        const taskData = {
          templateTitle: '淘宝商品评论爬取',
          templateTheme: '电商',
