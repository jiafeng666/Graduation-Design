  ...
  <div class="container">
    <div style="height: 250px; width: 100%;">
      ...
      <el-card class="box-card card-container">
        ...
        <div class="form-row">
          <span class="form-label">模板名称：</span> 拼多多商品信息爬取
        </div>
        <div class="form-row">
          <span class="form-label">采集字段：</span> 关键词，标题，链接，分类，销量，图片，店铺
        </div>
        <div class="form-row">
          <span class="form-label">关键词示例：</span> 水杯
        </div>
...
export default {
  ...
  methods: {
    crawl() {
      ...
      axios.get(`http://localhost:8080/pdd?key=${this.keyword}`).then(res => {
        const taskData = {
          templateTitle: '拼多多商品信息爬取',
          templateTheme: '电商',
