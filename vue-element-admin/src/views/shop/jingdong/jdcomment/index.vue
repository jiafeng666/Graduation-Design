  ...
  <div class="container">
    <div style="height: 250px; width: 100%;">
      ...
      <el-card class="box-card card-container">
        ...
        <div class="form-row">
          <span class="form-label">模板名称：</span> 京东评论爬取
        </div>
        <div class="form-row">
          <span class="form-label">采集字段：</span> skuid，商品链接，评论量，评论用户，评论内容，商品名，评论时间
        </div>
        <div class="form-row">
          <span class="form-label">关键词示例：</span> https://item.jd.com/100024333012.html (商品url)
        </div>
...
<script>
import img from '../img/jdcomment.png'
...
export default {
  ...
  methods: {
    crawl() {
      ...
      axios.get(`http://localhost:8080/jdcomment?key=${this.keyword}`).then(res => {
        const taskData = {
          templateTitle: '京东评论爬取',
          templateTheme: '电商',
