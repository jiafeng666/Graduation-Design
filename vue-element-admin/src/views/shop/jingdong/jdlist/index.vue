  ...
  <div class="container">
    <div style="height: 250px; width: 100%;">
      ...
      <el-card class="box-card card-container">
        ...
        <div class="form-row">
          <span class="form-label">模板名称：</span> 京东商品信息爬取
        </div>
        <div class="form-row">
          <span class="form-label">采集字段：</span> 关键词，标题，链接，价格，店铺，页数
        </div>
        <div class="form-row">
          <span class="form-label">关键词示例：</span> 风扇
        </div>
...
<script>
import img from '../img/jdlist.png'
...
export default {
  ...
  methods: {
    crawl() {
      ...
      axios.get(`http://localhost:8080/jdlist?key=${this.keyword}&page=${this.pagenum}`).then(res => {
        const taskData = {
          templateTitle: '京东商品信息爬取',
          templateTheme: '电商',
