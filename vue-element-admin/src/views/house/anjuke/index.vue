  ...
  <div class="container">
    <div style="height: 250px; width: 100%;">
      ...
      <el-card class="box-card card-container">
        ...
        <div class="form-row">
          <span class="form-label">模板名称：</span> 安居客房源信息爬取
        </div>
        <div class="form-row">
          <span class="form-label">采集字段：</span> 标题，链接，图片链接，租金，房型，面积，城市，区域，位置
        </div>
        <div class="form-row">
          <span class="form-label">关键词示例：</span> https://gz.zu.anjuke.com/fangyuan/2419580265847821 (房源url)
        </div>
...
<script>
import img from './img/anjuke.png'
...
export default {
  ...
  methods: {
    crawl() {
      ...
      axios.get(`http://localhost:8080/anjuke?key=${this.keyword}`).then(res => {
        const taskData = {
          templateTitle: '安居客房源信息爬取',
          templateTheme: '住房',
