  ...
  <div class="container">
    <div style="height: 250px; width: 100%;">
      ...
      <el-card class="box-card card-container">
        ...
        <div class="form-row">
          <span class="form-label">模板名称：</span> 网易城市新闻爬取
        </div>
        <div class="form-row">
          <span class="form-label">采集字段：</span> 城市id，标题，链接，来源，分类，图片，发布时间
        </div>
        <div class="form-row">
          <span class="form-label">关键词示例：</span> 441800 (cityid)，获取:https://v6-gw.m.163.com/nc/api/v1/local/city.html
        </div>
...
<script>
import img from './img/netease.png'
...
export default {
  ...
  methods: {
    crawl() {
      ...
      axios.get(`http://localhost:8080/netease?key=${this.keyword}`).then(res => {
        const taskData = {
          templateTitle: '网易城市新闻爬取',
          templateTheme: '新闻',
