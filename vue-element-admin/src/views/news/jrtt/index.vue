  ...
  <div class="container">
    <div style="height: 280px; width: 100%;">
      ...
      <el-card class="box-card card-container">
        ...
        <div class="form-row">
          <span class="form-label">模板名称：</span> 今日头条热榜爬取
        </div>
        <div class="form-row">
          <span class="form-label">采集字段：</span> 标题，链接，热度
        </div>
...
export default {
  ...
  methods: {
    crawl() {
      ...
      axios.get('http://localhost:8080/jrtt').then(res => {
        const taskData = {
          templateTitle: '今日头条热榜爬取',
          templateTheme: '新闻',
