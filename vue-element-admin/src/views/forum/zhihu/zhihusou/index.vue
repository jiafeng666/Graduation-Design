  ...
  <div class="container">
    <div style="height: 250px; width: 100%;">
      ...
      <el-card class="box-card card-container">
        ...
        <div class="form-row">
          <span class="form-label">模板名称：</span> 知乎搜索内容爬取
        </div>
        <div class="form-row">
          <span class="form-label">采集字段：</span> 关键词，标题，链接，类型，答主，答主主页，发布时间，导语
        </div>
        <div class="form-row">
          <span class="form-label">关键词示例：</span> 刘畊宏是哪里人
        </div>
...
<script>
import img from '../img/zhihu_sou.png'
...
export default {
  ...
  methods: {
    crawl() {
      ...
      axios.get(`http://localhost:8080/zhihusou?key=${this.keyword}`).then(res => {
        const taskData = {
          templateTitle: '知乎搜索内容爬取',
          templateTheme: '论坛',
