  ...
  <div class="container">
    <div style="height: 280px; width: 100%;">
      ...
      <el-card class="box-card card-container">
        ...
        <div class="form-row">
          <span class="form-label">模板名称：</span> 天涯热帖爬取
        </div>
        <div class="form-row">
          <span class="form-label">采集字段：</span> 标题，链接，类型，作者，作者主页，发布时间，图片，内容
        </div>
...
<script>
import img from './img/tianya.png'
...
export default {
  ...
  methods: {
    crawl() {
      ...
      axios.get('http://localhost:8080/tianya').then(res => {
        const taskData = {
          templateTitle: '天涯热帖爬取',
          templateTheme: '论坛',
