  ...
  <div class="container">
    <div style="height: 250px; width: 100%;">
      ...
      <el-card class="box-card card-container">
        ...
        <div class="form-row">
          <span class="form-label">模板名称：</span> 豆瓣演员信息爬取
        </div>
        <div class="form-row">
          <span class="form-label">采集字段：</span> 姓名，链接，照片，性别，职业，生日，出生地，介绍，作品
        </div>
        <div class="form-row">
          <span class="form-label">关键词示例：</span> https://movie.douban.com/celebrity/1054521/ (演员url)
        </div>
...
<script>
import img from '../img/douban_actor.png'
...
export default {
  ...
  methods: {
    crawl() {
      ...
      axios.get(`http://localhost:8080/dbactor?key=${this.keyword}`).then(res => {
        const taskData = {
          templateTitle: '豆瓣演员信息爬取',
          templateTheme: '论坛',
