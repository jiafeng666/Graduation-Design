  ...
  <div class="container">
    <div style="height: 250px; width: 100%;">
      ...
      <el-card class="box-card card-container">
        ...
        <div class="form-row">
          <span class="form-label">模板名称：</span> 豆瓣话题内容爬取
        </div>
        <div class="form-row">
          <span class="form-label">采集字段：</span> 标题，链接，作者，作者主页，发表时间，内容，评论人，评论人主页，评论时间，评论内容
        </div>
        <div class="form-row">
          <span class="form-label">关键词示例：</span> https://www.douban.com/group/topic/265650880/ (话题url)
        </div>
...
<script>
import img from '../img/douban_comment.png'
...
export default {
  ...
  methods: {
    crawl() {
      ...
      axios.get(`http://localhost:8080/dbcomment?key=${this.keyword}`).then(res => {
        const taskData = {
          templateTitle: '豆瓣话题内容爬取',
          templateTheme: '论坛',
