  ...
  <div class="container">
    <div style="height: 280px; width: 100%;">
      ...
      <el-card class="box-card card-container">
        ...
        <div class="form-row">
          <span class="form-label">模板名称：</span> 简书技术博文爬取
        </div>
        <div class="form-row">
          <span class="form-label">采集字段：</span> 标题，链接，作者，作者主页，评论数，点赞数，阅读数，导语
        </div>
...
<script>
import img from './img/jianshu.png'
...
export default {
  ...
  methods: {
    crawl() {
      ...
      axios.get('http://localhost:8080/jianshu').then(res => {
        const taskData = {
          templateTitle: '简书技术博文爬取',
          templateTheme: '博客',
