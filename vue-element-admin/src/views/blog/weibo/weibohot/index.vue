  ...
  <div class="container">
    <div style="height: 280px; width: 100%;">
      ...
      <el-card class="box-card card-container">
        ...
        <div class="form-row">
          <span class="form-label">模板名称：</span> 微博热搜爬取
        </div>
        <div class="form-row">
          <span class="form-label">采集字段：</span> 标题，链接，点击数，标签
        </div>
...
<script>
import img from '../img/weibo_hot.png'
...
export default {
  ...
  methods: {
    crawl() {
      ...
      axios.get('http://localhost:8080/weibohot').then(res => {
        const taskData = {
          templateTitle: '微博热搜爬取',
          templateTheme: '博客',
