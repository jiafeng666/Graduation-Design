  ...
  <div class="container">
    <div style="height: 250px; width: 100%;">
      ...
      <el-card class="box-card card-container">
        ...
        <div class="form-row">
          <span class="form-label">模板名称：</span> 微博搜索内容爬取
        </div>
        <div class="form-row">
          <span class="form-label">采集字段：</span> 关键词，微博ID，链接，内容，发表设备，发表时间，作者主页，作者昵称
        </div>
        <div class="form-row">
          <span class="form-label">关键词示例：</span> 毕业答辩
        </div>
...
<script>
import img from '../img/weibo_sou.png'
...
export default {
  ...
  methods: {
    crawl() {
      ...
      axios.get(`http://localhost:8080/weibosou?key=${this.keyword}&page=${this.pagenum}`).then(res => {
        const taskData = {
          templateTitle: '微博搜索内容爬取',
          templateTheme: '博客',
